...
|----------------- |----------- |---------:|---------:|---------:|
|**100** |**100** |**721.4 ms** | **48.62 ms** | **136.3 ms** | **680.0 ms** |

```
Mean = 721.446 ms, StdErr = 14.291 ms (1.98%), N = 91, StdDev = 136.323 ms
Min = 531.787 ms, Q1 = 616.948 ms, Median = 679.967 ms, Q3 = 789.543 ms, Max = 1,142.103 ms
IQR = 172.594 ms, LowerFence = 358.057 ms, UpperFence = 1,048.434 ms
ConfidenceInterval = [672.830 ms; 770.061 ms] (CI 99.9%), Margin = 48.616 ms (6.74% of Mean)
Skewness = 1.03, Kurtosis = 3.44, MValue = 2.47
-------------------- Histogram --------------------
[  492.008 ms ;   580.874 ms) | @@@@@@@
[  580.874 ms ;   660.433 ms) | @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
[  660.433 ms ;   722.284 ms) | @@@@@@@@@@@@@
[  722.284 ms ;   801.842 ms) | @@@@@@@@@@@@@@@@@@@
[  801.842 ms ;   883.084 ms) | @@@@@@@
[  883.084 ms ;   966.200 ms) | @@@@@@
[  966.200 ms ; 1,003.301 ms) |
[1,003.301 ms ; 1,102.324 ms) | @@@@@
[1,102.324 ms ; 1,181.882 ms) | @
---------------------------------------------------
```   

| Rules Count |Parallel Requests  |     Mean |    Error |   StdDev |
|----------------- |----------- |---------:|---------:|---------:|
|**100** |**200** | **860.1 ms** | **85.38 ms** | **236.6 ms** | **776.8 ms** |


```
Mean = 860.089 ms, StdErr = 25.079 ms (2.92%), N = 89, StdDev = 236.599 ms
Min = 560.480 ms, Q1 = 693.398 ms, Median = 776.771 ms, Q3 = 952.996 ms, Max = 1,636.198 ms
IQR = 259.598 ms, LowerFence = 304.001 ms, UpperFence = 1,342.393 ms
ConfidenceInterval = [774.704 ms; 945.473 ms] (CI 99.9%), Margin = 85.384 ms (9.93% of Mean)
Skewness = 1.49, Kurtosis = 4.54, MValue = 2.91
-------------------- Histogram --------------------
[  541.530 ms ;   677.787 ms) | @@@@@@@@@@@
[  677.787 ms ;   816.893 ms) | @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
[  816.893 ms ;   959.228 ms) | @@@@@@@@@@@@@
[  959.228 ms ; 1,132.247 ms) | @@@@@@@@@
[1,132.247 ms ; 1,299.564 ms) | @@@
[1,299.564 ms ; 1,438.671 ms) | @@@@@
[1,438.671 ms ; 1,505.036 ms) |
[1,505.036 ms ; 1,644.142 ms) | @@@
---------------------------------------------------         
```                                                          
